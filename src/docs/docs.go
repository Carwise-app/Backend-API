    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/carwise.UpdateUserRoleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "User role updated successfully\" example:{\"message\":\"User role updated successfully\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Validation error\" example:{\"error\":\"Invalid role value\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "403": {
                        "description": "Forbidden\" example:{\"error\":\"Only admin users can update user roles\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Server error\" example:{\"error\":\"Internal server error\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/notification/delete-all": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Delete All Notifications Response\" example:{\"message\":\"All notifications deleted successfully\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/notification/mark-all-read": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "Mark All as Read Response\" example:{\"message\":\"All notifications marked as read successfully\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
